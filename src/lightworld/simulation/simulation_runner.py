...
from lightworld.graph.zep_graph_memory_updater import ZepGraphMemoryManager
from lightworld.simulation.simulation_ipc import SimulationIPCClient, CommandType, IPCResponse

logger = get_logger('lightworld.simulation_runner')
...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        if enable_graph_memory_update:
            if not graph_id:
                raise ValueError("graph_id is required when enabling graph memory update")

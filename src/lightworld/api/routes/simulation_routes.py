...
from lightworld.config import Config
...
from lightworld.simulation.simulation_manager import SimulationManager, SimulationStatus
from lightworld.simulation.simulation_runner import SimulationRunner, RunnerStatus
from lightworld.telemetry.logging_config import get_logger
from lightworld.domain.project import ProjectManager

logger = get_logger('lightworld.api.simulation')
...
def prepare_simulation():
    import threading
    import os
    from lightworld.domain.task import TaskManager, TaskStatus
    from lightworld.config import Config
...
def get_prepare_status():
    from lightworld.domain.task import TaskManager

...
from microworld.storage.report_repository import FileReportRepository
from microworld.graph.zep_tools import (
    ZepToolsService,
    SearchResult,
    InsightForgeResult,
    PanoramaResult,
...
logger = get_logger('microworld.report_agent')
...
class ReportConsoleLogger:
    ...
    def _setup_file_handler(self):
        ...
        loggers_to_attach = [
            'microworld.report_agent',
            'microworld.zep_tools',
        ]

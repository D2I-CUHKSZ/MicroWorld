...
from microworld.application.simulation_preparation_service import SimulationPreparationFactory
from microworld.telemetry.logging_config import get_logger
from microworld.storage.simulation_state_repository import FileSimulationStateRepository

logger = get_logger('microworld.simulation')
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "commands": {
                ...
                "parallel": f"uv run microworld-parallel-sim --config {config_path}",
            },
            "instructions": (
                ...
                f"   - Run both platforms in parallel: uv run microworld-parallel-sim --config {config_path}"
            )
        }

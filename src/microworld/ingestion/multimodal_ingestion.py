...
MicroWorld ontology/Zep/simulation flow can stay unchanged.
"""
...
from microworld.ingestion.file_parser import FileParser
...
logger = get_logger("microworld.multimodal_ingestion")
...
class MultimodalIngestionService:
    ...
    def _ingest_video_file(
        ...
        warnings: List[str] = []
        cache_dir = tempfile.mkdtemp(prefix="microworld_video_")
        try:

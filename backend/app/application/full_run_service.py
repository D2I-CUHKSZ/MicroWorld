...
from app.modules.simulation.cluster_cli import (
...
from app.utils.report_agent import ReportAgent, ReportManager, ReportStatus
from app.utils.simulation_manager import SimulationManager
...
class FullRunPaths:
    ...
    def create(cls) -> "FullRunPaths":
        ...
        return cls(
            ...
            latest_manifest_path=(backend_dir / "uploads" / "full_runs" / "latest.json"),
...
class FullRunService:
    ...
    def run_parallel_simulation(
        ...
        cmd = [
            sys.executable,
            str(self.paths.parallel_sim_script),
            "--config",
